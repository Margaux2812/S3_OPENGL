...
int main(int argc, char** argv) {
    ...
    SDLWindowManager windowManager(800, 600, "TP1 exo 4 Quad couleur");
    ...
    Vertex2DColor vertices[] = { 
        ...
        //Deuxieme triangle
        Vertex2DColor(glm::vec2(0.25f, 0.25f), glm::vec3(0.f, 1.f, 0.f)), //Premier sommet rouge
        Vertex2DColor(glm::vec2(0.25f, -0.25f), glm::vec3(1.f, 0.f, 0.f)), //Deuxieme sommet vert
        Vertex2DColor(glm::vec2(-0.25f, -0.25f), glm::vec3(0.f, 0.f, 1.f)) //Troisieme sommet bleu
    };
